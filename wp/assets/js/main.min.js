(() => {
  ...
  // src/js/utils/fvSliderUtils.js
  function initFvSlider(selector = ".js-fv-slider") {
  ...
  // src/js/utils/albumSliderUtils.js
  function initAlbumSlider(selector = ".js-album-slider") {
    const el = document.querySelector(selector);
    if (!el) return;
    new core_default(el, {
  ...
  // src/js/utils/countdownUtils.js
  function initWeddingCountdown(targetDate = "2026-11-21T13:50:00") {
    ...
    const setText = (els, text) => els.forEach((el) => {
      el.textContent = text;
    });
    const update = () => {
    ...
    update();
    const timerId = setInterval(update, 1e3);
  }

  // src/js/utils/hamburgerUtils.js
  ...
  function initHamburgerMenu({
    ...
    const $nav = (0, import_jquery.default)(navSelector);
    const $btn = (0, import_jquery.default)(btnSelector);
    const $body = (0, import_jquery.default)(bodySelector);
    const $extraEls = extraTargets.map((sel) => (0, import_jquery.default)(sel));
  ...
  // src/js/utils/headerHeightUtils.js
  function setHeaderHeight(selector = ".l-header") {
  ...
  // src/js/utils/footerHeightUtils.js
  function setFooterHeight(selector = ".l-footer") {
  ...
  function initAnchorSmoothScroll() {
    ...
    const scrollToTarget = (target, smooth = true) => {
      ...
      if (scrollParent === document.scrollingElement || scrollParent === document.documentElement) {
        ...
        const offset = target.getBoundingClientRect().top - scrollParent.getBoundingClientRect().top + scrollParent.scrollTop - scrollMarginTop;
  ...
  // src/js/utils/fadeInUtils.js
  function initFadeIn(selector = ".js-fadein") {
  ...
  // src/js/utils/postalCodeUtils.js
  function initPostalCodeAutofill({
    ...
    const fillAddress = () => __async(null, null, function* () {
      const digits = postalCodeEl.value.replace(/[^0-9]/g, "");
      if (digits.length !== 7) return;
      try {
        const res = yield fetch(`https://zipcloud.ibsnet.co.jp/api/search?zipcode=${digits}`);
